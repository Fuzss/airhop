...
public class ConfigBuildHandler {
    ...
    public static class GeneralConfig {
        ...
        private GeneralConfig(String name) {
            ...
            this.summonCloud = BUILDER.comment("Summon a small particle cloud at every position the player air hops from.").define("Summon Particle Cloud", true);
    ...
    public static class EnchantmentConfig {
        ...
        private EnchantmentConfig(String name) {
            ...
            this.rarity = BUILDER.comment("Rarity of this enchantment.").defineEnum("Enchantment Rarity", Enchantment.Rarity.RARE);
            this.type = BUILDER.comment("Defines the piece of armor this enchantment can be applied to. If \"ALL\" is used, the levels on all armor pieces will be combined.").defineEnum("Enchantment Type", ArmorType.LEGGINGS);
        ...
        public enum ArmorType {
            ...
            HELMET(EnchantmentType.ARMOR_HEAD),
            CHESTPLATE(EnchantmentType.ARMOR_CHEST),
            LEGGINGS(EnchantmentType.ARMOR_LEGS),
            BOOTS(EnchantmentType.ARMOR_FEET);

            private EnchantmentType enchantmentType;

            ArmorType(EnchantmentType type) {
